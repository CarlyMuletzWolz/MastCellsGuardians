...
#cd /Users/lkgentry/Library/CloudStorage/OneDrive-SmithsonianInstitution/Kelsey\'s\ Project/Kelsey-2-371840470/FASTQ_Generation_2022-12-05_16_00_42Z-636614131 
...
setwd("/Users/lkgentry/OneDrive - Smithsonian Institution/Kelsey's Project/Kelsey-2-371840470/FASTQ_Generation_2022-12-05_16_00_42Z-636614131")


path <- "/Users/lkgentry/OneDrive - Smithsonian Institution/Kelsey's Project/Kelsey-2-371840470/FASTQ_Generation_2022-12-05_16_00_42Z-636614131"
list.files(path)
...
## an average pf 80% with this is good. This run is 56% which is way better than first run. 
...
#errors still dont look good for this run. Should follow line closely
...
saveRDS(seqtab, "XengK2022exp2run2_seqtab.rds")

#will merge this with XengK2022exp2_seqtab.rds that I created previously
...
## Still retain 93.5% of sequences after chimera removal
...
write.csv(track, "dada2_output_run2.csv")
...
write.csv(species_site, "XENGK2022EXP2_feature_table_run2.csv")

write.csv(tax, "XENGK2022EXP2_taxonomy_run2.csv")
write.csv(seqs, 'XENGK2022EXP2_feature_DNAsequences_run2.csv')
...
writeFasta(seqsDf, "XENGK2022EXP2_DNAsequences_run2.fasta")
